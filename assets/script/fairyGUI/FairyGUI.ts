/**
 * FairyGUI 对外统一导出入口，聚合常用组件、类型、事件、补间与工具模块。
 */
...
export type { ListItemRenderer } from "./GList";
...
export type { Frame } from "./display/MovieClip";

export { FEvent as Event } from "./event/Event";
